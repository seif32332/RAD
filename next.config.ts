...
const securityHeaders = [
  ...
  // camera + geolocation: same origin only, for the portal self clock-in (GPS + face check).
  // Keep in sync with ops/nginx/tenant.conf.template (nginx replaces this header in production).
